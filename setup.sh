...
if [ ! -e ".user.cfg" ] 
then
	printf "Type your here username: "
	read uname
...
updatedw() {
	...
	then
		...
		git clone https://github.com/Cyber-Foxx/T-styling.git
		cd T-styling
		prm sh
		clear
		bash
...
txt() { cat \$1.*; }
figlet $uname
PS1='\033[1;91MCyber-Foxx[\033[1;93m\W\033[1;91m]:
# \033[1;92m'
if [ -d \"\$HOME/T-styling\" ]
then
	if grep -q '# 011' \"/data/data/com.termux/files/home/T-styling/.user.cfg\"
	then
		lnum=\$( sed '3q;d' \"/data/data/com.termux/files/home/T-styling/.user.cfg\" )
		lnum=\$( echo \$lnum | sed 's/# 011//g' )
		lnum=\$( echo \$lnum | sed 's/ //g' )
		echo \$( sed '3q;d' \"/data/data/com.termux/files/home/T-styling/.user.cfg\" )
			if [[ ! \$lnum -eq 5 ]]
			then
				lnum=\$((\$lnum+1))
		...
		echo hi
		echo \"1 # 011\" >> \"/data/data/com.termux/files/home/T-styling/.user.cfg\"
	fi
else
	updatedw
fi
